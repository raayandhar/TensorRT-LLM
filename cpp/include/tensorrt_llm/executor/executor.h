...
public:
    ...
    explicit CacheTransceiverConfig(
        ...
        std::optional<std::chrono::milliseconds> kvTransferTimeoutMs = std::nullopt);
    ...
    void setKvTransferTimeoutMs(std::optional<std::chrono::milliseconds> kvTransferTimeoutMs);
