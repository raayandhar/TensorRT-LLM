...
void initConfigBindings(nb::module_& m)
{
    ...
    nb::class_<tle::CacheTransceiverConfig>(m, "CacheTransceiverConfig")
        .def(nb::init([](std::optional<tle::CacheTransceiverConfig::BackendType> backend,
        ...
        }), nb::arg("backend") = std::nullopt, nb::arg("max_tokens_in_buffer") = std::nullopt, nb::arg("kv_transfer_timeout_ms") = std::nullopt)
        .def_prop_rw(
        ...
        .def_prop_rw("kv_transfer_timeout_ms", 
